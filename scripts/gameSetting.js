...
let PopUpEvent = {
  ...
  "폭짜" : new SinglePopUpEvent("폭짜", null, [3,4,5], true, 2, "날씨 좋은 날 분반 친구들끼리 모여 폭풍의 언덕 위에서 하는 폭짜는 언제나 훈훈하고 행복합니다. "),
  "집가기" : new SinglePopUpEvent("집가기", null, null, false, 0, "이번 주말은 집을 갔다 와야겠어요! 집에 가서 맛있는 것도 많이 먹고 용돈도 받고… 벌써부터 설레네요!"),
  "축제당일" : new SinglePopUpEvent("축제당일", null, [10], true, 0, "오늘은 축제/포카전입니다. 공연/경기도 보고 술도 마시니 스트레스가 풀리는 것 같습니다."),
  "종총" : new SinglePopUpEvent("종총", null, [13,14], true, 2, "종총은 왜 기말 전에 하는 거죠? 가긴 가야하는데 시험공부가...."),
  "콘서트" : new SinglePopUpEvent("콘서트", null, null, false, 0, "어머! 이건 꼭 봐야 해! 이번에 컴백 콘서트라구요!"),
  "자체휴강" : new SinglePopUpEvent("자체휴강", null, null, false, 0, "분명히 알람을 맞춰놨는데??? 오늘은 휴강인가 보네요"),
  "밤샘공부" : new SinglePopUpEvent("밤샘공부", null, [7,8,13,14], false, 1, "밤샘으로 수업에 집중을 하나도 못하는 주인공.. 점심 대신 낮잠을 선택해 오후 수업 내내 굶주립니다."),
  "데이트" : new SinglePopUpEvent("데이트", null, null, false, 2, "오늘은 데이트 하는 날! 장소는... 청암?!"),
  "황금연휴" : new SinglePopUpEvent("황금연휴", null, null, true, 0, "방학 체험판! 어디로 놀러가지?"),
  "생일" : new SinglePopUpEvent("생일", null, null, false, 2, "친구 생일인데 몰래 무슨 이벤트를 준비할까요? 기대되네요!"),
  "폭피" : new SinglePopUpEvent("폭피", null, [3,4,5], true, 2, "폭짜도 있는데 폭피도 있죠! 폭피폭피폭피폭피폭피폭피폭피폭"),
  "재실험" : new SinglePopUpEvent("재실험", null, null, false, 1, "실험을 기분좋게 끝냈는데 보고서 쓰려니 데이터가 이상하네요..? 재실험 해야되나ㅠㅠ"),
  "지도회식" : new SinglePopUpEvent("지도회식", null, null, true, 2, "교수님과 지도사단과 같이 밥도 먹고 서로 친해져서 좋네요."),
  "교수님과의면담" : new SinglePopUpEvent("교수님과의면담", null, null, false, 2, "교수님이랑 면담하는데 긴장되네요. 가서 무슨 말을 할까요?"),
  "발표준비" : new SinglePopUpEvent("발표준비", null, null, false, 1, "발표준비는 당일날 아침에 하면 충분하죠? 그렇다고 말해줘요ㅠㅠ"),
  "깜짝휴강" : new SinglePopUpEvent("깜짝휴강", null, null, false, 0, "[Web 발신]오늘 수업은 휴강입니다."),
  "쇼핑" : new SinglePopUpEvent("쇼핑", null, null, false, 0, "잔액이 부족합니다... 응?"),
  "여행" : new SinglePopUpEvent("여행", null, null, false, 0, "푸른 언덕에~ 배낭을 메고~ 여행을 떠나요!"),
  "스크리밍데이" : new SinglePopUpEvent("스크리밍데이", null, [7,8,15,16], true, 1, "시!!험!!으아악!!!!!"),
  "봉사활동" : new SinglePopUpEvent("봉사활동", null, null, false, 2, "바쁜 일상이지만 봉사활동을 하니 보람차네요. 몸은 힘들지만 기분은 좋아졌어요."),
  "가족방문" : new SinglePopUpEvent("가족방문", null, null, false, 2, "이번엔 반가운 가족들이 학교로 와줬네요. 부모님이랑 밥도 먹고 기분이 좋아졌어요."),
  "문콜" : new SinglePopUpEvent("문콜", null, null, false, 1, "이번 주 문콜은 제가 좋아하는 밴드가 온데요! 꼭 보러 가야겠어요~"),
  "김욱식사의날" : new SinglePopUpEvent("김욱식사의날", null, [10], true, 0, "1년에 1번 학식 업그레이드!!! 오랜만에 학식이나 먹어볼까?"),
  "공양식" : new SinglePopUpEvent("공양식", null, [4], true, 2, "선배님 밥사드릴게요!"),
  "층간담회" : new SinglePopUpEvent("층간담회", null, [2,3], true, 2, "층 모두가 모여서 밥도 먹고 훈훈한 경험이네요. 오늘은 피자라죠?"),
  "smp" : new SinglePopUpEvent("smp", null, null, false, 1, "수업 하나도 안 들었는데 smp 개꿀~"),
